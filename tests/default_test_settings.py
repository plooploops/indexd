from indexd.default_settings import *  # noqa: F403
...
settings = {"config": CONFIG, "auth": AUTH}  # noqa: F405

# psql connection string
# takes form "postgres://username:password@hostname/db_name"
